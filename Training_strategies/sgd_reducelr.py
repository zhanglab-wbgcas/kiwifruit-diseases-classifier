...
def main():
    ...
    pth_file_path = os.path.join(pth_save_directory, f"01best_{args.model}_{args.step}_{args.gamma}_reducelr_sgd_model.pth")
    png_file_path = os.path.join(pic_save_directory, f"01{args.model}_{args.step}_{args.gamma}_reducelr_sgd_loss_acc.png")
