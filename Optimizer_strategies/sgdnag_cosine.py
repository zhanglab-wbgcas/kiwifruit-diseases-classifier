...
def main():
    ...
    pth_file_path = os.path.join(pth_save_directory, f"best_{args.model}_{args.step}_{args.gamma}_cosinelr_sgdnag_model.pth")
    png_file_path = os.path.join(pic_save_directory, f"{args.model}_{args.step}_{args.gamma}_cosinelr_sgdnag_loss_acc.png")
